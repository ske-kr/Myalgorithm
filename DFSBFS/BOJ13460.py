##일반적인 BFS문제
## 루트찾기는 대부분 BFS문제로 푼다고 생각하자
## 여기서 중요한 점은 
## 두개의 점이 동시에 움직이기때문에
## 두 좌표에 대한 visited 체크가 동시에 이뤄져야하고
## 둘다 visited일때만 그 방향탐색을 멈출수있다.
##그렇기때문에 해당 코드에서는 4-D array를 이용했다 참신한 방법
##해당 방법에서 queue를 deque로바꿔주면
##수행시간은 백준기준 늘어나네..왜지??.... 68ms -> 112ms
